...
INSERT INTO Products(precio, stock, id_Categoria, user_creador_id, descripcion, detalles, imagen,destacado) VALUES
                                                                                                      ...
                                                                                                      (25.99, 5, 8, 1, 'Espada de Hierro', 'Espada de un guerrero antiguo, encontrada en una cueva perdida.', 'imagen1.url', false),
                                                                                                      (30.50, 7, 8, 1, 'Espada de Acero', 'Espada forjada con acero refinado, usada por los guardianes del reino.', 'imagen2.url', true),
                                                                                                      (18.75, 10, 8, 1, 'Espada Oxidada', 'Espada oxidada, pero aún funcional, descubierta en un campo de batalla.', 'imagen3.url', false),
                                                                                                      (45.00, 3, 8, 1, 'Espada Templada', 'Espada de acero templado, con grabados antiguos en la hoja.', 'imagen4.url', true),
                                                                                                      (60.99, 2, 8, 1, 'Espada Legendaria', 'Espada imbuida con magia de fuego, conocida por su historia en batallas épicas.', 'imagen5.url', false),
                                                                                                      (50.25, 8, 8, 1, 'Espada Ceremonial', 'Espada utilizada en antiguos rituales de los reyes del pasado.', 'imagen6.url', false),
                                                                                                      (39.99, 6, 8, 1, 'Espada de Plata', 'Espada de plata, usada por cazadores de criaturas mágicas.', 'imagen7.url', true),
                                                                                                      (22.49, 4, 8, 1, 'Espada Corta', 'Espada corta, preferida por los mercenarios de las tierras del sur.', 'imagen8.url', false),
                                                                                                      (35.00, 12, 8, 1, 'Espada de Guardia', 'Espada utilizada por los guardias reales, famosa por su durabilidad.', 'imagen9.url', false),
                                                                                                      (27.80, 9, 8, 1, 'Espada Decorada', 'Espada con empuñadura adornada con joyas preciosas.', 'imagen10.url', true),
                                                                                                      (40.50, 5, 8, 1, 'Espada de Batalla', 'Espada equilibrada para combates prolongados en la línea frontal.', 'imagen11.url', false),
                                                                                                      (55.99, 3, 8, 1, 'Espada Mágica', 'Espada mágica utilizada por los magos guerreros de las tierras del este.', 'imagen12.url', false),
                                                                                                      (33.75, 6, 8, 1, 'Espada Rúnica', 'Espada con runas que brillan en la oscuridad, otorgando poderes misteriosos.', 'imagen13.url', true),
                                                                                                      (29.99, 4, 8, 1, 'Espada Larga', 'Espada larga de acero común, usada por los soldados del reino.', 'imagen14.url', false),
                                                                                                      (24.50, 7, 8, 1, 'Espada de Entrenamiento', 'Espada ligera y perfecta para los nuevos reclutas en el ejército.', 'imagen15.url', true),
                                                                                                      (48.99, 2, 8, 1, 'Espada de Cristal', 'Espada extremadamente afilada, pero frágil debido a su material de cristal.', 'imagen16.url', false),
                                                                                                      (37.20, 5, 8, 1, 'Espada Rompeescudos', 'Espada diseñada específicamente para romper los escudos enemigos.', 'imagen17.url', false),
                                                                                                      (32.99, 9, 8, 1, 'Espada de Guerra', 'Espada pesada diseñada para causar el máximo daño en el campo de batalla.', 'imagen18.url', true),
                                                                                                      (42.50, 3, 8, 1, 'Espada Antigua', 'Espada perteneciente a un rey caído, con una historia llena de leyendas.', 'imagen19.url', false),
                                                                                                      (26.99, 8, 8, 1, 'Espada Ligera', 'Espada rápida y ágil, ideal para combates veloces y movimientos rápidos.', 'imagen20.url', false);